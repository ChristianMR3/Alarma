...
char contrasena[] = "4554"; // En esta linea creamos la constante de cadena llamada contraseña (el numero 2222 puede ser cambiado)
...
void loop() {
  ...
  if (valor == HIGH) {
    ...
    tone(3, 698.46, 500);  // fa 5 Lanza señal a 698.46Hz por el pin 3 durante 600ms.
